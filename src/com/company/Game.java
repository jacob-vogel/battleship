...
public class Game {
    ...
    public boolean validGuess(int guess, boolean player){
        ...
        if(!player && (player1Board.gridPersonal[guess] == 3 || player1Board.gridPersonal[guess] == 2)) {
                return false;
        }
        else if (player2Board.gridPersonal[guess] == 3 || player2Board.gridPersonal[guess] == 2){
                return false;
        }
        return true;
    }
